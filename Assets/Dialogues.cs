...
public class Dialogues : MonoBehaviour
{
    ...
    static public string FinishPlantLavender2 = "The main target for the garden is to <color=red>upgrade your tree</color>. Check what resource you need for upgrading tree.";
    ...
    static public string SeeBird = "Sometimeds a bird will fly through your garden. <color=red>Click</color> it to recieve a surprise!";
